...
class DetectionModelTrainer:
    ...
    def setTrainConfig(self,  object_names_array, batch_size= 32, num_experiments=100, train_from_pretrained_model=""):
    ...
    def evaluateModel(self, model_path, json_path, batch_size=8, iou_threshold=0.5, object_threshold=0.2, nms_threshold=0.45):
